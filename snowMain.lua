...
local Utility = {}
local Objects = {}
function Snow:DraggingEnabled(frame, parent)
...
function Snow.CreateLib(kavName, themeList)
    ...
    Snow:DraggingEnabled(MainHeader, Main)
    ...
    function Snow:ChangeColor(prope,color)
